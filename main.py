...
class Menu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # buttons
        addbutton = tk.Button(self, text="Add a person", fg="black", border=0, font=("", 29, "bold"), padx=179,
                              command=lambda: controller.show_frame(AddAPerson)).place(x=112, y=158)

        rembutton = tk.Button(self, text="Remove a person", fg="black", border=0, font=("", 29, "bold"), padx=153,
                              command=lambda: controller.show_frame(RemoveAPerson)).place(x=111, y=221)

        showbutton = tk.Button(self, text="Show Database", fg="black", border=0, font=("", 29, "bold"), padx=163,
                               command=lambda: controller.show_frame(ShowDB)).place(x=111, y=285)

        startbutton = tk.Button(self, text="Start Attendance", fg="black", border=0, font=("", 29, "bold"), padx=153,
                                command=lambda: self.startAttendance()).place(x=111, y=349)
